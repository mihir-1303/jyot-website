...
export default async function EditVideoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main><p className="eyebrow">CMS / Videos</p><h1 className="serif mb-8 mt-2 text-5xl">Edit video</h1><ContentForm kind="video" action={saveVideo} value={serialize(item) as Record<string, unknown>} options={options} /></main>;
}
