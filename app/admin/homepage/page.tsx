...
export default async function HomepagePage() {
  ...
  const candidates = { articles: data.articles.map((item) => ({ id: String(item._id), title: String(item.title) })), videos: data.videos.map((item) => ({ id: String(item._id), title: String(item.title) })), research: data.research.map((item) => ({ id: String(item._id), title: String(item.title) })), collections: data.collections.map((item) => ({ id: String(item._id), title: String(item.title) })), categories: data.categories.map((item) => ({ id: String(item._id), name: item.name })) };
