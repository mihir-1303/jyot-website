...
export default async function EditArticlePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main><p className="eyebrow">CMS / Articles</p><h1 className="serif mb-8 mt-2 text-5xl">Edit article</h1><ContentForm kind="article" action={saveArticle} value={item as unknown as Record<string, unknown>} options={options} /></main>;
}
